...
func seedFoods(db *gorm.DB) error {
	...
	foods := []Food{
		// MPASI Foods - Grains & Carbohydrates
		{Name: "Bubur Beras", Category: "mpasi", CaloriesPer100g: 130, ProteinPer100g: 2.7, CarbsPer100g: 28.2, FatPer100g: 0.3},
		{Name: "Bubur Beras Merah", Category: "mpasi", CaloriesPer100g: 111, ProteinPer100g: 2.6, CarbsPer100g: 23.5, FatPer100g: 0.9},
		...
		{Name: "Ubi Ungu", Category: "mpasi", CaloriesPer100g: 90, ProteinPer100g: 1.8, CarbsPer100g: 20.7, FatPer100g: 0.2},
		{Name: "Oatmeal Bayi", Category: "mpasi", CaloriesPer100g: 68, ProteinPer100g: 2.4, CarbsPer100g: 12.0, FatPer100g: 1.4},
		{Name: "Pasta", Category: "mpasi", CaloriesPer100g: 131, ProteinPer100g: 5.0, CarbsPer100g: 25.0, FatPer100g: 1.1},
		{Name: "Roti Gandum", Category: "mpasi", CaloriesPer100g: 247, ProteinPer100g: 13.0, CarbsPer100g: 41.0, FatPer100g: 3.4},
		...
		{Name: "Apel", Category: "mpasi", CaloriesPer100g: 52, ProteinPer100g: 0.3, CarbsPer100g: 13.8, FatPer100g: 0.2},
		{Name: "Pir", Category: "mpasi", CaloriesPer100g: 57, ProteinPer100g: 0.4, CarbsPer100g: 15.2, FatPer100g: 0.1},
		{Name: "Pepaya", Category: "mpasi", CaloriesPer100g: 43, ProteinPer100g: 0.5, CarbsPer100g: 10.8, FatPer100g: 0.3},
		{Name: "Mangga", Category: "mpasi", CaloriesPer100g: 60, ProteinPer100g: 0.8, CarbsPer100g: 15.0, FatPer100g: 0.4},
		{Name: "Jeruk", Category: "mpasi", CaloriesPer100g: 47, ProteinPer100g: 0.9, CarbsPer100g: 11.8, FatPer100g: 0.1},
		{Name: "Melon", Category: "mpasi", CaloriesPer100g: 34, ProteinPer100g: 0.8, CarbsPer100g: 8.2, FatPer100g: 0.2},
		{Name: "Semangka", Category: "mpasi", CaloriesPer100g: 30, ProteinPer100g: 0.6, CarbsPer100g: 7.6, FatPer100g: 0.2},
		{Name: "Blueberry", Category: "mpasi", CaloriesPer100g: 57, ProteinPer100g: 0.7, CarbsPer100g: 14.5, FatPer100g: 0.3},
		{Name: "Strawberry", Category: "mpasi", CaloriesPer100g: 32, ProteinPer100g: 0.7, CarbsPer100g: 7.7, FatPer100g: 0.3},

		// MPASI Foods - Vegetables
		...
		{Name: "Bayam", Category: "mpasi", CaloriesPer100g: 23, ProteinPer100g: 2.9, CarbsPer100g: 3.6, FatPer100g: 0.4},
		{Name: "Kacang Polong", Category: "mpasi", CaloriesPer100g: 81, ProteinPer100g: 5.4, CarbsPer100g: 14.5, FatPer100g: 0.4},
		{Name: "Jagung Manis", Category: "mpasi", CaloriesPer100g: 86, ProteinPer100g: 3.3, CarbsPer100g: 18.7, FatPer100g: 1.4},
		{Name: "Tomat", Category: "mpasi", CaloriesPer100g: 18, ProteinPer100g: 0.9, CarbsPer100g: 3.9, FatPer100g: 0.2},
		{Name: "Timun", Category: "mpasi", CaloriesPer100g: 15, ProteinPer100g: 0.7, CarbsPer100g: 3.6, FatPer100g: 0.1},
		{Name: "Kembang Kol", Category: "mpasi", CaloriesPer100g: 25, ProteinPer100g: 1.9, CarbsPer100g: 5.0, FatPer100g: 0.3},
		{Name: "Zucchini", Category: "mpasi", CaloriesPer100g: 17, ProteinPer100g: 1.2, CarbsPer100g: 3.1, FatPer100g: 0.3},

		// MPASI Foods - Proteins
		{Name: "Ayam Giling", Category: "mpasi", CaloriesPer100g: 165, ProteinPer100g: 31.0, CarbsPer100g: 0.0, FatPer100g: 3.6},
		{Name: "Daging Sapi Giling", Category: "mpasi", CaloriesPer100g: 250, ProteinPer100g: 26.0, CarbsPer100g: 0.0, FatPer100g: 15.0},
		{Name: "Ikan Salmon", Category: "mpasi", CaloriesPer100g: 208, ProteinPer100g: 20.0, CarbsPer100g: 0.0, FatPer100g: 13.0},
		{Name: "Ikan Kakap", Category: "mpasi", CaloriesPer100g: 100, ProteinPer100g: 20.5, CarbsPer100g: 0.0, FatPer100g: 1.3},
		{Name: "Ikan Tuna", Category: "mpasi", CaloriesPer100g: 144, ProteinPer100g: 23.3, CarbsPer100g: 0.0, FatPer100g: 4.9},
		{Name: "Telur", Category: "mpasi", CaloriesPer100g: 155, ProteinPer100g: 13.0, CarbsPer100g: 1.1, FatPer100g: 11.0},
		{Name: "Tahu", Category: "mpasi", CaloriesPer100g: 76, ProteinPer100g: 8.0, CarbsPer100g: 1.9, FatPer100g: 4.8},
		{Name: "Tempe", Category: "mpasi", CaloriesPer100g: 193, ProteinPer100g: 20.8, CarbsPer100g: 7.6, FatPer100g: 10.8},
		{Name: "Keju", Category: "mpasi", CaloriesPer100g: 402, ProteinPer100g: 25.0, CarbsPer100g: 1.3, FatPer100g: 33.0},
		{Name: "Yogurt Plain", Category: "mpasi", CaloriesPer100g: 59, ProteinPer100g: 10.0, CarbsPer100g: 3.6, FatPer100g: 0.4},

		// Mother Foods - Grains & Carbohydrates
		{Name: "Nasi Putih", Category: "ibu", CaloriesPer100g: 130, ProteinPer100g: 2.7, CarbsPer100g: 28.2, FatPer100g: 0.3},
		{Name: "Nasi Merah", Category: "ibu", CaloriesPer100g: 111, ProteinPer100g: 2.6, CarbsPer100g: 23.5, FatPer100g: 0.9},
		{Name: "Nasi Coklat", Category: "ibu", CaloriesPer100g: 112, ProteinPer100g: 2.3, CarbsPer100g: 23.5, FatPer100g: 0.8},
		{Name: "Quinoa", Category: "ibu", CaloriesPer100g: 120, ProteinPer100g: 4.4, CarbsPer100g: 21.3, FatPer100g: 1.9},
		{Name: "Oatmeal", Category: "ibu", CaloriesPer100g: 389, ProteinPer100g: 16.9, CarbsPer100g: 66.3, FatPer100g: 6.9},
		{Name: "Roti Gandum Utuh", Category: "ibu", CaloriesPer100g: 247, ProteinPer100g: 13.0, CarbsPer100g: 41.0, FatPer100g: 3.4},
		{Name: "Kentang Rebus", Category: "ibu", CaloriesPer100g: 77, ProteinPer100g: 2.0, CarbsPer100g: 17.5, FatPer100g: 0.1},
		{Name: "Ubi Jalar Panggang", Category: "ibu", CaloriesPer100g: 90, ProteinPer100g: 2.0, CarbsPer100g: 20.7, FatPer100g: 0.2},

		// Mother Foods - Proteins
		{Name: "Dada Ayam", Category: "ibu", CaloriesPer100g: 165, ProteinPer100g: 31.0, CarbsPer100g: 0.0, FatPer100g: 3.6},
		{Name: "Paha Ayam Tanpa Kulit", Category: "ibu", CaloriesPer100g: 209, ProteinPer100g: 26.0, CarbsPer100g: 0.0, FatPer100g: 10.9},
		{Name: "Daging Sapi Tanpa Lemak", Category: "ibu", CaloriesPer100g: 250, ProteinPer100g: 26.0, CarbsPer100g: 0.0, FatPer100g: 15.0},
		{Name: "Ikan Salmon Panggang", Category: "ibu", CaloriesPer100g: 208, ProteinPer100g: 20.0, CarbsPer100g: 0.0, FatPer100g: 13.0},
		{Name: "Ikan Tuna", Category: "ibu", CaloriesPer100g: 144, ProteinPer100g: 23.3, CarbsPer100g: 0.0, FatPer100g: 4.9},
		{Name: "Ikan Kembung", Category: "ibu", CaloriesPer100g: 205, ProteinPer100g: 19.0, CarbsPer100g: 0.0, FatPer100g: 13.9},
		{Name: "Udang", Category: "ibu", CaloriesPer100g: 99, ProteinPer100g: 24.0, CarbsPer100g: 0.2, FatPer100g: 0.3},
		{Name: "Telur Ayam", Category: "ibu", CaloriesPer100g: 155, ProteinPer100g: 13.0, CarbsPer100g: 1.1, FatPer100g: 11.0},
		{Name: "Tempe Goreng", Category: "ibu", CaloriesPer100g: 193, ProteinPer100g: 20.8, CarbsPer100g: 7.6, FatPer100g: 10.8},
		{Name: "Tahu Putih", Category: "ibu", CaloriesPer100g: 76, ProteinPer100g: 8.0, CarbsPer100g: 1.9, FatPer100g: 4.8},

		// Mother Foods - Vegetables
		{Name: "Bayam Hijau", Category: "ibu", CaloriesPer100g: 23, ProteinPer100g: 2.9, CarbsPer100g: 3.6, FatPer100g: 0.4},
		{Name: "Kangkung", Category: "ibu", CaloriesPer100g: 19, ProteinPer100g: 2.6, CarbsPer100g: 3.1, FatPer100g: 0.3},
		{Name: "Brokoli Hijau", Category: "ibu", CaloriesPer100g: 34, ProteinPer100g: 2.8, CarbsPer100g: 6.6, FatPer100g: 0.4},
		{Name: "Wortel Mentah", Category: "ibu", CaloriesPer100g: 41, ProteinPer100g: 0.9, CarbsPer100g: 9.6, FatPer100g: 0.2},
		{Name: "Tomat Merah", Category: "ibu", CaloriesPer100g: 18, ProteinPer100g: 0.9, CarbsPer100g: 3.9, FatPer100g: 0.2},
		{Name: "Paprika Merah", Category: "ibu", CaloriesPer100g: 31, ProteinPer100g: 1.0, CarbsPer100g: 6.0, FatPer100g: 0.3},
		{Name: "Kacang Panjang", Category: "ibu", CaloriesPer100g: 31, ProteinPer100g: 1.8, CarbsPer100g: 7.1, FatPer100g: 0.1},
		{Name: "Terong", Category: "ibu", CaloriesPer100g: 25, ProteinPer100g: 1.0, CarbsPer100g: 5.9, FatPer100g: 0.2},

		// Mother Foods - Fruits
		{Name: "Pisang Ambon", Category: "ibu", CaloriesPer100g: 89, ProteinPer100g: 1.1, CarbsPer100g: 22.8, FatPer100g: 0.3},
		{Name: "Apel Merah", Category: "ibu", CaloriesPer100g: 52, ProteinPer100g: 0.3, CarbsPer100g: 13.8, FatPer100g: 0.2},
		{Name: "Jeruk Manis", Category: "ibu", CaloriesPer100g: 47, ProteinPer100g: 0.9, CarbsPer100g: 11.8, FatPer100g: 0.1},
		{Name: "Pepaya Matang", Category: "ibu", CaloriesPer100g: 43, ProteinPer100g: 0.5, CarbsPer100g: 10.8, FatPer100g: 0.3},
		{Name: "Mangga Harum Manis", Category: "ibu", CaloriesPer100g: 60, ProteinPer100g: 0.8, CarbsPer100g: 15.0, FatPer100g: 0.4},
		{Name: "Alpukat Mentega", Category: "ibu", CaloriesPer100g: 160, ProteinPer100g: 2.0, CarbsPer100g: 8.5, FatPer100g: 14.7},
		{Name: "Semangka Merah", Category: "ibu", CaloriesPer100g: 30, ProteinPer100g: 0.6, CarbsPer100g: 7.6, FatPer100g: 0.2},

		// Mother Foods - Dairy & Nuts
		{Name: "Susu Sapi", Category: "ibu", CaloriesPer100g: 61, ProteinPer100g: 3.2, CarbsPer100g: 4.8, FatPer100g: 3.3},
		{Name: "Susu Almond", Category: "ibu", CaloriesPer100g: 17, ProteinPer100g: 0.6, CarbsPer100g: 1.5, FatPer100g: 1.1},
		{Name: "Yogurt Plain", Category: "ibu", CaloriesPer100g: 59, ProteinPer100g: 10.0, CarbsPer100g: 3.6, FatPer100g: 0.4},
		{Name: "Yogurt Greek", Category: "ibu", CaloriesPer100g: 97, ProteinPer100g: 9.0, CarbsPer100g: 3.9, FatPer100g: 5.0},
		{Name: "Keju Cheddar", Category: "ibu", CaloriesPer100g: 402, ProteinPer100g: 25.0, CarbsPer100g: 1.3, FatPer100g: 33.0},
		{Name: "Kacang Almond", Category: "ibu", CaloriesPer100g: 579, ProteinPer100g: 21.2, CarbsPer100g: 21.6, FatPer100g: 49.9},
		{Name: "Kacang Mete", Category: "ibu", CaloriesPer100g: 553, ProteinPer100g: 18.2, CarbsPer100g: 30.2, FatPer100g: 43.9},
		{Name: "Kacang Tanah", Category: "ibu", CaloriesPer100g: 567, ProteinPer100g: 25.8, CarbsPer100g: 16.1, FatPer100g: 49.2},
		{Name: "Kacang Hijau", Category: "ibu", CaloriesPer100g: 347, ProteinPer100g: 23.9, CarbsPer100g: 62.9, FatPer100g: 1.2},
		{Name: "Kacang Merah", Category: "ibu", CaloriesPer100g: 333, ProteinPer100g: 22.5, CarbsPer100g: 60.0, FatPer100g: 1.1},
	}
